package com.example.pendaftaranmahasiswa.adapter;
...
import com.example.pendaftaranmahasiswa.R;
import com.example.pendaftaranmahasiswa.model.resultMahasiswa;
import com.example.pendaftaranmahasiswa.model.resultResponse;
import com.example.pendaftaranmahasiswa.services.ApiClient;
import com.example.pendaftaranmahasiswa.services.ApiService;
...
public class ReadAdapter extends RecyclerView.Adapter<ReadAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvAlamat.setText(resultMahasiswas.get(position).getAlamat());
        ...
        holder.itemView.setOnLongClickListener(v -> {
            ...
            edtAlamat.setText(resultMahasiswas.get(position).getAlamat());
            ...
            btnUpdate.setOnClickListener(v1 -> {
                updateData(new resultMahasiswa(edtID.getText().toString(), edtNIM.getText().toString(),
                        ...
                        edtJurusan.getText().toString(), edtAlamat.getText().toString()));
                dialog.dismiss();
            });
    ...
    private void updateData(resultMahasiswa resultMahasiswa) {
        ...
        apiService = ApiClient.getClient().create(ApiService.class);
        Call<resultResponse> resultInsertCall = apiService.update(resultMahasiswa.getId(), resultMahasiswa.getNim(), resultMahasiswa.getNama(),resultMahasiswa.getFakultas(),
                resultMahasiswa.getJurusan(), resultMahasiswa.getAlamat());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvNama, tvNim, tvFakultas, tvJurusan, tvAlamat;
