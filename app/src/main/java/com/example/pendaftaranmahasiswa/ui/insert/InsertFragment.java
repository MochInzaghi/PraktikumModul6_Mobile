package com.example.pendaftaranmahasiswa.ui.insert;
...
public class InsertFragment extends Fragment {
    private EditText edtNIM, edtNama, edtFakultas, edtJurusan, edtAlamat;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        edtAlamat = root.findViewById(R.id.edt_alamat);
